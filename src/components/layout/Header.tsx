...
import Logo from "@/assets/logo-bh.png";

export default function Header() {
    return (
        <header className="flex justify-between fixed top-0 left-0 right-0 z-50 px-4 py-4 bg-black">
            {/* Section for logo */}
            <div className="flex ml-0 md:ml-10">
                <Image src={Logo} alt="Logo" height={50} width={50} />
                <h1 className="mt-2 text-2xl font-bold text-white">
                    Bilal <span className="text-sky-600">Hassan</span>
                </h1>
            </div>
            {/* Navigations */}
            <div>
            ...
            <div className="px-10 mt-2 hidden md:block">
                <a href="mailto:siddiquibilal882@gmail.com">
                    <Button className="bg-sky-600 font-serif font-semibold rounded-xl">
                        HIRE ME
                    </Button>
                </a>
            </div>
            ...
            <Sheet>
                <SheetTrigger className="md:hidden">
                    <Menu className="text-sky-600 w-8 h-8" />
                </SheetTrigger>
                <SheetContent className="bg-slate-800 text-white p-0">
                    ...
                    <div className="mt-4 ml-3 mr-5">
                        <a href="mailto:siddiquibilal882@gmail.com">
                            <Button className="bg-sky-600 font-serif font-semibold w-full">
                                HIRE ME
                            </Button>
                        </a>
                    </div>
