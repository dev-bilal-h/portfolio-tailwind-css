...
import AboutProfile from "@/assets/profile-img.jpg";

const About = () => {
  return (
    //About Image section
    <div className="flex flex-col items-center justify-center min-h-screen bg-black px-4 sm:px-8 md:px-16 pt-32 sm:pt-28"> 
      <div className="relative w-48 h-48 sm:w-64 sm:h-64 mb-6 flex items-center justify-center">
        <div className="absolute w-52 h-52 sm:w-64 sm:h-64 border-8 border-t-transparent border-sky-600 rounded-full spin-slow "></div>
        <div className="relative w-44 h-44 sm:w-56 sm:h-56 rounded-full border-2 border-sky-600 flex items-center justify-center "> 
          <Image
            src={AboutProfile}
            alt="Profile Picture"
            width={218}  
      ...
      <p className="text-2xl font-semibold text-white mt-2 animate-slideInFromBottom">Front-end Developer</p>
