  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col items-center pt-10">
      ...
      <div className="w-full sm:w-3/4 md:w-2/3 lg:w-1/2 mt-6 relative px-4 sm:px-0 mb-16 animate-slideInLeft">
        ...
        <div className="border-l-4 border-sky-600 relative">
          {/* Right-Education Block */}
          <div className="mb-8 md:mb-10 ml-6 sm:ml-10 flex flex-col md:flex-row-reverse items-start">
            <div className="w-4 h-4 sm:w-5 sm:h-5 bg-sky-600 rounded-full animate-pulse mt-1 sm:mr-4"></div>
            <div className="mt-2 md:mt-0">
              <p className="text-sky-600 font-semibold text-sm sm:text-lg">2022 - 2023</p>
              <div className="bg-sky-600 p-3 sm:p-4 rounded-lg border-2 border-sky-500 mt-2 hover:shadow-[0_4px_20px_rgba(0,255,255,0.6)] hover:shadow-cyan-500">
          ...
          {/*Left-Education Block */}
          <div className="mb-8 md:mb-10 ml-6 sm:ml-10 flex flex-col md:flex-row items-start">
            <div className="w-4 h-4 sm:w-5 sm:h-5 bg-sky-600 rounded-full animate-pulse mt-1 sm:mr-4"></div>
            <div className="mt-2 md:mt-0">
              <p className="text-sky-600 font-semibold text-sm sm:text-lg">2024 - 2025</p>
              <div className="bg-sky-600 p-3 sm:p-4 rounded-lg border-2 border-sky-500 mt-2 hover:shadow-[0_4px_20px_rgba(0,255,255,0.6)] hover:shadow-cyan-500">
                <h3 className="font-semibold text-base sm:text-lg">Intermediate (Computer Science)</h3>
                <p className="text-xs sm:text-sm">
                  Pursued college studies with Science at Government College Forman Nazimabad.
                </p>
              </div>
            </div>
          </div>
