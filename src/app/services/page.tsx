...
const Services = () => {
  return (
    ...
    <div className="bg-black pt-24 sm:pt-20 pb-12 px-4 sm:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-16 mb-12 animate-slideInFromBottom">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-sky-700 text-white p-6 sm:p-8 rounded-xl lg:rounded-xl shadow-lg flex flex-col items-start transform transition-transform duration-300 hover:scale-105"
          >
            <div className="text-sky-200 mb-4">{service.icon}</div>
